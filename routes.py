...
async def read_conversation(
    ...
    create_user_history= UserResponse(
...
async def read_all(db:db_dependency,current_user: schemas.UserInDB = Depends(auth.get_current_user)):

    return db.query(UserResponse).filter(UserResponse.user_id==current_user.id).all() 
